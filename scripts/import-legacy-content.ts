...
function hasFeatureableTitle(value: unknown) {
  ...
  if (/\b\d+\s*с\./i.test(title)) return false
  if (/\bп\.л\./i.test(title)) return false
  if (/\b\d+\s*с\.\s*[-–]?\s*\d+(?:[.,]\d+)?\s*п\.л\./i.test(title)) return false
    ...
    'home',
    {
      ...
      layout: [
        ...
        },
        {
          ...
          description:
            'Профиль собран по подтвержденным биографическим и авторским источникам, без рекламной переписи и вымышленных деталей.',
          content: richTextParagraphs([
            ...
            'После университета работал в органах прокуратуры Москвы, а с 1993 года занимается адвокатской деятельностью в связке с Московской городской коллегией адвокатов и Адвокатской конторой №39 «Академическая».',
            'Ключевые темы профессионального профиля: уголовно-правовая защита, пересмотр судебных ошибок, суд присяжных и научная работа по вопросам уголовного процесса.',
          ]),
          highlights: [
            {
              title: 'Образование',
